...
export const router = createRouter({
  ...
  routes: [
    ...
    { path: '/security-workbench', name: 'security-workbench', component: () => import('@/views/SecurityWorkbenchView.vue') },
    { path: '/assistants', name: 'assistants', component: () => import('@/views/AssistantListView.vue') },
    { path: '/assistants/:id', name: 'assistant-detail', component: () => import('@/views/AssistantDetailView.vue') },
